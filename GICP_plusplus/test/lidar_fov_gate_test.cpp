...
void convertToBigEndian(sensor_msgs::msg::PointCloud2& cloud) {
  if (!gicp_localization::hostIsBigEndian()) {
...
TEST(LidarFovGate, AcceptsNominalRobinWCoverage) {
  ...
  gicp_localization::VerticalFovMeasurement measurement;
  EXPECT_TRUE(gicp_localization::verticalFovAccepted(
...
TEST(LidarFovGate, RejectsNarrowCoverage) {
  ...
  gicp_localization::VerticalFovMeasurement measurement;
  EXPECT_FALSE(gicp_localization::verticalFovAccepted(
      cloud, 27.0, 100, &measurement));
...
TEST(LidarFovGate, FarFieldReturnsAreUnaffectedByTheRangeFloor) {
  ...
  gicp_localization::VerticalFovMeasurement measurement;
  EXPECT_TRUE(gicp_localization::verticalFovAccepted(cloud, 27.0, 100, &measurement));
...
TEST(LidarFovGate, AllNearFieldCloudIsRejectedNotAccepted) {
  ...
  gicp_localization::VerticalFovMeasurement measurement;
  EXPECT_FALSE(gicp_localization::verticalFovAccepted(cloud, 27.0, 100, &measurement));
